...
class GatewayFilterTest {
    ...
    @Test
    void doFilterInternal_WithoutSecret_ShouldReturnForbidden() throws ServletException, IOException {
        request.setRequestURI("/books/1");
    ...
    @Test
    void doFilterInternal_ApiDocsPath_ShouldProceedWithoutSecret() throws ServletException, IOException {
